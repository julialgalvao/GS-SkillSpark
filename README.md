...
O SkillSpark foi desenvolvido com o objetivo de proporcionar uma ferramenta simples e intuitiva para:
...
O app também conta com uma aba **Explore**, trazendo conteúdos sobre tendências do mercado e sugestões de skills importantes.
...
Estas dependências são instaladas automaticamente ao rodar `npm install`, mas aqui está a lista completa:
...
O Expo hoje é usado via `npx`, mas se quiser instalar:

```
npm install --global expo-cli
```

Se aparecer “deprecated”, não tem problema — o Expo ainda funciona com npx.
...
│   │   ├── explore.tsx       # Tela Explore personalizada
│── src/
│   ├── components/
│   │   ├── SkillForm.js
│   │   ├── SkillList.js
